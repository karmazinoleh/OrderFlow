...
public class OrderSaga {
    ...
    public void handleEvent(@Payload OrderCreatedEvent event) {
        ...
        orderHistoryService.add(Long.valueOf(event.orderId()), OrderStatus.CREATED);
    }
    ...
    public void handleEvent(@Payload PaymentProcessedEvent event) {
        ...
        ClearCartCommand clearCartCommand = new ClearCartCommand(
                orderRepository.findById(event.orderId()).get().getUserId());
    ...
    public void handleEvent(@Payload PaymentFailedEvent event){
        ...
        CancelProductReservationCommand cancelProductReservationCommand =
                new CancelProductReservationCommand(event.orderId(), event.products());
